...
public class Game extends JFrame {
    ...
    private String criptografia = "!kevin!#$%&/()!";

    public Game() {
        initComponents();
        setSize(520, 600);
        setTitle("Jogo da Velha - Kevin");
        setResizable(false);
    ...
    public void inicia() {
        ...
        port.setText("5000");
        nick.setText("");
        textArea.append("Mais informações: facebook.com/kevin.bencke\nDesenvolvido por Kevin Andriel Bencke.\n");
